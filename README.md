...
## News
- [2025/04] [Beta] AWQ now supports DeepSeek-R1-Distilled models. You can find an example [here](https://github.com/mit-han-lab/llm-awq/blob/main/scripts/DeepSeek-R1-Distill_example.sh).
