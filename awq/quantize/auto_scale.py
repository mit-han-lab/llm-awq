...
def scale_gelu_fc(gelu, fc, scales):
    assert isinstance(gelu, nn.GELU) or isinstance(gelu, BloomGelu) or isinstance(gelu, GELUActivation)
...
def apply_scale(module, scales_list, input_feat_dict=None):
    for prev_op_name, layer_names, scales in scales_list:
        ...
        elif isinstance(prev_op, nn.GELU) or isinstance(prev_op, BloomGelu) or isinstance(prev_op, GELUActivation):
